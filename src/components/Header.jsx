...
export default function Header() {
  return (
    <header className="header">
      <img src={ProfileImage} alt="Matt Pahuta" />
      <div className="info">
        <h1 className="name-heading">Matt Pahuta</h1>
        <p className="title">Frontend Engineer</p>
        <a className="web-link" href="https://mattpahuta.com">mattpahuta.com</a>
        <div className="button-container">
          <a href="#" className="button email-button">
          ...
          <a href="#" className="button social-button">
