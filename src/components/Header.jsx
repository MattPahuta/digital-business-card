...
export default function Header() {
  return (
    <header className="header">
      <img className="profile-image" src={ProfileImage} alt="Matt Pahuta" />
      <div className="info">
        <h1 className="name-heading">Matt Pahuta</h1>
        <p className="title">Frontend Engineer</p>
        <a className="web-link" href="https://mattpahuta.com" target="true">mattpahuta.com</a>
        <div className="button-container">
          <a href="mailto:mhpahuta@gmail.com" className="button email-button">
          ...
          <a href="https://www.linkedin.com/in/mattpahuta/" target="true" className="button social-button">
